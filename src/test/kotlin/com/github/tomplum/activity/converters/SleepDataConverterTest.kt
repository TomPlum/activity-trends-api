...
class SleepDataConverterTest {
    ...
    private fun getSource(): SleepData {
        ...
        return SleepData(listOf(SleepSnapshot(LocalDateTime.of(2020, 9, 20, 16, 0, 0), session)))
    }

    private fun getExpected(): SleepDataResponse {
        val snapshotData = SleepDataSnapshot("2020-09-22T22:30:00", "2020-09-23T07:31:00", 8, false, 78, 1, 4, 2, 1, 12, "Good")
        return SleepDataResponse(listOf(snapshotData))
    }
}